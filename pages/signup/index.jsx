...
const SignUp = () => {
  ...
  function signUp(e) {
    ...
    fetch("https://server.niloofarclinic.beauty/api/user/signUpByMobilePhone/", requestOptions)
...
function paste(event) {
  ...
  for (let i = 0; i < paste.length; i++) {
    ...
    return ( 
        <div className="signup-page" lang="en">
            <div className="lp-header">
             <Link href="/"><a> {"<"} <p> بازگشت به صفحه اصلی </p> </a></Link> 
            </div>
            <Head>
    <title>ثبت نام - کلینیک زیبایی نیلوفر</title>
        </Head>
            ...
            <div className="su-main">
                <div className="su-one">
                    <div className="su-forms" id="before">
                        ...
                        <img src={g10} alt="" />
                        <h3>همیشه در کنارتون هستیم</h3>
                        </div>
                        <p id="error">شما قبلا ثبت نام کردید</p>
                        <input type="text" placeholder="نام و نام خانوادگی" id="name"/>
                        <input type="text" placeholder="شماره تلفن همراه" id="number"/>
                      <div className="suf-btn"> <button onClick={signUp}>ثبت نام</button></div> 
                        <h5>قبلا ثبت نام کردید؟ <Link href="/login"><a> وارد شوید </a></Link> </h5>
                    ...
                    <div className="su-forms" id="after">
                      ...
                      <div className="suf-btn"> <button onClick={inside}>ثبت نام</button></div> 
                        <h5>قبلا ثبت نام کردید؟ <Link href="/login"><a>وارد شوید </a></Link> </h5>
